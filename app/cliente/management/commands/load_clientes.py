    ...
    with open('Cliente.csv', 'r', encoding='utf-8') as file:
        ...
        for row in reader:
            ...
            obj = Cliente(
                ...
                vencimentocertificado=row['vencimentocertificado'] if row['vencimentocertificado'] else None,
                ...
                grupoeconomico_id=row['grupoeconomico_id'] if row['grupoeconomico_id'] else None,
